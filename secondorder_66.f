...
c---- input values
      ...
      w_access(1) = (208.499094 - 3.1443)*2*pi
      w_access(2) = (208.499094 - 3.1225)*2*pi
      w_access(3) = (208.499094 - 3.0881)*2*pi
      w_access(4) = (208.499094 - 3.0465)*2*pi
      w_access(5) = (208.499094 - 2.9983)*2*pi            
      w_access(6) = (208.499094 - 2.9444)*2*pi
...
C$OMP& PRIVATE(s2,s3,s4,s5,s6,m1,m2,m3,m4,m5,m6)
      do x=0,131071
...
C$OMP DO PRIVATE(x,o0,o1,o2,o3,o4,o5,o6,o7,n0,n1,n2,n3,n4,n5,n6,n7)
C$OMP& SCHEDULE(STATIC)
      do x=0,32767
        o0 = A(8*x); o1 = A(8*x+1);
...
C$OMP& PRIVATE(m1,m2,m3,m4,m5,m6,s1,s2,s3,s4,s5,s6)
      do x=0,32767
